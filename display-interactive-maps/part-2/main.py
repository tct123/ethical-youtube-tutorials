            ...
            controls=[
                ...
                ft.OutlinedButton(
                    ...
                    on_click=lambda e: m.move_to(
                        destination=map.MapLatitudeLongitude(40, 50),
                        animation_duration=ft.Duration(seconds=1),
                    ),
                ),
                ft.OutlinedButton(
                    "Zoom in",
                    on_click=lambda e: m.zoom_in(
                        animation_duration=ft.Duration(seconds=4)
                    ),
                ),
                ft.OutlinedButton(
                    "Zoom out",
                    on_click=lambda e: m.zoom_out(
                        animation_duration=ft.Duration(seconds=4)
                    ),
                ),
                ...
                ft.OutlinedButton(
                    "Center on ",
                    on_click=lambda e: m.center_on(
                        point=map.MapLatitudeLongitude(40, 50), zoom=4
                    ),
                ),
            ]
        ),
